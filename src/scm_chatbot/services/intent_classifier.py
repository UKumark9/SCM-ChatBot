...
class IntentClassifier:
    ...
    def classify_query(self, query: str) -> Dict[str, Any]:
        ...
        result = {
            ...
            "reasoning": self._explain_classification(
                query_type, policy_score, data_score, domain
            ),
        }

        logger.info(
            f"Query classification: {query_type} ({domain}) - confidence: {confidence:.2f}"
        )
    ...
    def _explain_classification(
        self, query_type: str, policy_score: float, data_score: float, domain: str
    ) -> str:
